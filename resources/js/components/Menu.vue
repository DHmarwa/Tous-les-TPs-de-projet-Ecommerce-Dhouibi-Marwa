    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarColor01">
        <ul class="navbar-nav me-auto">
          ...
          <li class="nav-item">
            <router-link to="/shopping" class="nav-item nav-link">
              Shopping Cart
            </router-link>
          </li>
          <li class="nav-item">
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <li class="nav-item me-3">
            ...
            >
              ...
              <span
                v-if="$store.state.Articlestore.cart.length > 0"
  ...
  <nav class="navbar navbar-expand-lg bg-info" data-bs-theme="dark">
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarColor01">
        <ul class="navbar-nav me-auto">
          <li class="nav-item">
            <router-link class="nav-link active" to="/listcat">Catégories</router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link active" to="/listsouscat">Sous Catégories</router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link active" to="/listart">Articles</router-link>
          </li>
          <li class="nav-item">
            <router-link to="/shopping" class="nav-item nav-link">Shopping Cart</router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link active" to="/articlestable">Articles table</router-link>
          </li>
          <li class="nav-item dropdown">
